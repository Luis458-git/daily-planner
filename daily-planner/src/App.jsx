...
import ConsultaCedula from './Components/ConsultaCedula'
...
const pages = ['dashboard', 'week', 'timer', 'activities', 'stats', 'consultas', 'calculadora']
